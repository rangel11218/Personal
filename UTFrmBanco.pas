...
begin
  if InteliDialog.ShowModal('Eliminar registro', 'Ha solicitado eliminar el regsitro:' + #10 + #10 + cdDAtos.FieldByName('NombreCorto').AsString + #10 + #10 + '¿Está seguro de eliminarlo en este momento?', mtConfirmation, [mbYes, mbNo], 0) = mrYes then
    cdDatos.Delete;
end;
...
begin
  ...
  begin
    ...
    try
      ...
      begin
        Obj := eRazonSocial;
        raise InteligentException.CreateByCode(18, ['Razón Social']);
      end;
