object FrmProgramaVacaciones: TFrmProgramaVacaciones
  Left = 0
  Top = 0
  Caption = 'Programa de Vacaciones'
  ClientHeight = 377
  ClientWidth = 716
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    object tvDatos: TcxGridDBTableView
      ...
      object InicioVacaciones: TcxGridDBColumn
        Caption = 'Inicio Vacaciones'
        DataBinding.FieldName = 'InicioVacaciones'
        Width = 103
      end
      ...
      object DiasVacaciones: TcxGridDBColumn
        Caption = 'Dias Vacaciones'
        DataBinding.FieldName = 'DiasVacaciones'
        Width = 99
      end
      object DiasProgramados: TcxGridDBColumn
        DataBinding.FieldName = 'Programadas'
      end
      object FechaAplicacion: TcxGridDBColumn
  ...
  object pnlPendientes: TPanel
    ...
    object cxGrid2: TcxGrid
      ...
      Align = alClient
      TabOrder = 0
      object tvPendientes: TcxGridDBTableView
        PopupMenu = pmOpcVac
        Navigator.Buttons.CustomButtons = <>
        OnCellDblClick = tvPendientesCellDblClick
        DataController.DataSource = dsPendientes
        DataController.Summary.DefaultGroupSummaryItems = <>
        DataController.Summary.FooterSummaryItems = <>
        DataController.Summary.SummaryGroups = <>
        OptionsData.CancelOnExit = False
        ...
        object DiasPag: TcxGridDBColumn
          Caption = 'Pagadas'
          DataBinding.FieldName = 'DiasPag'
        end
        ...
        object Programadas: TcxGridDBColumn
          DataBinding.FieldName = 'Programadas'
        end
        object FechaProgramadas: TcxGridDBColumn
          Caption = 'Fecha Prog.'
          DataBinding.FieldName = 'FechaProgramadas'
        end
      end
      object cxGrid2Level1: TcxGridLevel
        GridView = tvPendientes
      end
    end
    object Panel3: TPanel
      ...
      Padding.Bottom = 4
      TabOrder = 1
      object btnProgramar: TAdvGlowButton
        Left = 7
        Top = 5
        Width = 100
        Height = 31
      ...
      object btnEditarCancel: TAdvGlowButton
        Left = 359
        Top = 5
        Width = 100
        Height = 31
  ...
  object pnlProgramar: TPanel
    ...
    object Panel5: TPanel
      ...
      Padding.Bottom = 4
      TabOrder = 0
      object btnEditOk: TAdvGlowButton
        Left = 39
        Top = 5
        Width = 100
        Height = 31
    ...
    object ePagadas: TcxDBCalcEdit
      Left = 76
      Top = 18
      DataBinding.DataField = 'Programadas'
      DataBinding.DataSource = dsPagadas
      TabOrder = 1
      Width = 121
    end
    object FechaOficio: TcxDBDateEdit
      Left = 76
      Top = 46
      DataBinding.DataField = 'FechaOficio'
      DataBinding.DataSource = dsPagadas
      TabOrder = 2
      Width = 93
    end
    object eFechaAplicacion: TcxDBDateEdit
      Left = 76
      Top = 71
  ...
  object cdVacaciones: TZReadOnlyQuery
  ...
  object dsPagadas: TDataSource
    DataSet = cdPagadas
    Left = 456
    Top = 160
  end
  object frxDBVacaciones: TfrxDBDataset
    UserName = 'frxDBVacaciones'
  ...
  object frxHistorialVacaciones: TfrxReport
    Version = '5.3.14'
    ...
    ReportOptions.CreateDate = 42948.450391006910000000
    ReportOptions.LastChange = 42976.594845706020000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo65: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'Art. 76 de la Ley Federal del Trabajo, Art. 25 Reglamento Interi' +
              'or del Trabajo '#243' disposiciones institucionales),'
            ''
            
              'entre los meses de   y  del presente a'#241'o, acogiendose al cronogr' +
              'ama vacacional de su unidad.')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo19: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBPendientes."APaterno"] [frxDBPendientes."AMaterno"]'
            '')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo24: TfrxMemoView
          ...
          Frame.Width = 1.500000000000000000
          Memo.UTF8W = (
            '[frxDBPendientes."NombreLocalidad"]')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo27: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'S  O  L  I  C  I  T  O     V  A  C  A  C  I  O  N  E  S')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo44: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop]
          Frame.Width = 1.500000000000000000
          Fill.BackColor = 5789784
          HAlign = haCenter
          Memo.UTF8W = (
            'D'#237'as de Vacaciones')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo52: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'E S P A C I O   P A R A   S E R   L L E N A D O   P O R   R  E  ' +
              'C  U  R  S  O  S     H  U  M  A  N  O  S')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo54: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[frxDBPendientes."APaterno"] [frxDBPendientes."AMaterno"] [frxDB' +
              'Pendientes."Nombres"]')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo62: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBPendientes."FechaReingreso"]')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo64: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '  para que goce de sus vacaciones anuales. a las que tiene derec' +
              'ho (de acuerdo al')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo66: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'DIAS DE VACACIONES POR PERIODOS (Hasta m'#225'ximo ___________ d'#237'as)')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo73: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[YearOf(<frxDBPendientes."Aplicacion">)] - [YearOf(<frxDBPendien' +
              'tes."FechaFin">)]')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo77: TfrxMemoView
          ...
          Frame.Width = 1.500000000000000000
          Memo.UTF8W = (
            'TOTAL D'#205'AS DE VACACIONES DEL TRABAJADOR(A)')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo78: TfrxMemoView
          ...
          Frame.Width = 1.500000000000000000
          Memo.UTF8W = (
            'DIAS PENDIENTES DE VACACIONES DEL TRABAJADOR(A)')
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 740.409927000000000000
        Condition = 'frxDBPendientes."IdPersonalIMSS"'
        ...
        object Picture1: TfrxPictureView
          ...
          Picture.Data = {
            ...
            097048597300000EC200000EC20115284A80000055D349444154785EED7D057C
        ...
        object Memo3: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '"F  O  R  M  U  L  A  R  I  O     D  E     V  A  C  A  C  I  O  ' +
              'N  E  S"')
          ParentFont = False
          VAlign = vaCenter
        end
  ...
  object pmOpcVac: TPopupMenu
    Left = 664
    Top = 128
    object ProgramarVacaciones1: TMenuItem
      Caption = 'Programar Vacaciones'
    end
    object Realizarpagodevacacionesprogramadas1: TMenuItem
      Caption = 'Realizar pago de vacaciones programadas'
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object Generaroficiodesolicituddevacaciones1: TMenuItem
      Caption = 'Generar oficio de solicitud de vacaciones'
      OnClick = Generaroficiodesolicituddevacaciones1Click
    end
  end
  object frxDBPendientes: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'FechaProgramadas=FechaProgramadas'
      ...
      'DiasFecProg=DiasFecProg'
      'MesFecProg=MesFecProg'
      'AnioFecProg=AniosFecProg'
      'DiasFecOfi=DiasFecOfi'
      'MesFecOfi=MesFecOfi'
      'AnioFecOfi=AniosFecOfi'
      'DIASFecHasta=DIASFecHasta'
      'MESFecHasta=MESFecHasta'
      'ANIOFecHasta=ANIOFecHasta'
      'FechaFin=FechaFin')
