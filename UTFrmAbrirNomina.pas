...
uses
  ...
  Dialogs, ComCtrls, ExtCtrls, UInteliDialog, DB, DBClient, URegistro, StdCtrls,
  AdvGlowButton, DBCtrls, JvLabel, dxSkinsCore, dxSkinBlack,
  dxSkinBlue, dxSkinBlueprint, dxSkinCaramel, dxSkinCoffee, dxSkinDarkRoom,
  dxSkinDarkSide, dxSkinDevExpressDarkStyle, dxSkinDevExpressStyle, dxSkinFoggy,
  dxSkinGlassOceans, dxSkinHighContrast, dxSkiniMaginary, dxSkinLilian,
  dxSkinLiquidSky, dxSkinLondonLiquidSky, dxSkinMcSkin, dxSkinMetropolis,
  dxSkinMetropolisDark, dxSkinMoneyTwins, dxSkinOffice2007Black, UDosCapas,
  ...
  dxSkinsdxBarPainter, cxClasses, dxBar, cxButtons, cxGroupBox, cxGraphics,
  cxControls, cxLookAndFeels, cxLookAndFeelPainters, cxContainer, cxEdit, Menus,
  DateUtils, ZAbstractRODataset, ZAbstractDataset, ZDataset, Frm_Connection,
...
type
  ...
  TFrmAbrirNomina = class(TForm)
    ...
    cdNominaMod: TZQuery;
    cdAnios: TZReadOnlyQuery;
    cdTiposNomina: TZReadOnlyQuery;
    cdNomina: TZReadOnlyQuery;
    cdMeses: TZReadOnlyQuery;
...
begin
  ...
  Try
    ...
    if CargarDatosFiltrados(TZQuery(dsNominaFuera.DataSet), 'IdNomina', [TInfoNomina(tvNominas.Selected.Data).IdNomina]) then
    begin
      Try
