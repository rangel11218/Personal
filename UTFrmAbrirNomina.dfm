object FrmAbrirNomina: TFrmAbrirNomina
  ...
  object cdNominaMod: TZQuery
    Params = <>
    Left = 184
    Top = 184
  end
  object cdAnios: TZReadOnlyQuery
    Params = <>
    Left = 24
    Top = 80
  end
  object cdTiposNomina: TZReadOnlyQuery
    Params = <>
    Left = 96
    Top = 88
  end
  object cdNomina: TZReadOnlyQuery
    Params = <>
    Left = 24
    Top = 144
  end
  object cdMeses: TZReadOnlyQuery
    Params = <>
    Left = 24
    Top = 232
  end
