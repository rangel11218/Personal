object FrmPermisoAusencia: TFrmPermisoAusencia
  Left = 0
  Top = 0
  Caption = 'Solicitud de permisos de ausencia laboral'
  ClientHeight = 468
  ClientWidth = 768
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object JvLabel4: TJvLabel
      ...
      Width = 99
      Height = 13
      Caption = 'T'#233'rmino del permiso:'
      Transparent = True
      HotTrack = False
    end
    ...
    object IdSolicita: TDBLookupComboBox
      ...
      DataSource = dsPermisoAusencia
      KeyField = 'IdPersonal'
      ListField = 'NombreCompleto'
      ListSource = dsSolicita
      TabOrder = 1
    end
    object cbTipoPermiso: TComboBox
      Left = 113
      Top = 137
      Width = 128
      Height = 21
    ...
    object EspecificarOtro: TDBMemo
      Left = 313
      Top = 231
      Width = 440
      Height = 34
      DataField = 'EspecificarOtro'
      DataSource = dsPermisoAusencia
      Enabled = False
      TabOrder = 4
    end
    ...
    object PorHoras: TDBCheckBox
      Left = 113
      Top = 60
      Width = 131
      Height = 17
      Caption = 'Permiso por horas'
      DataField = 'PorHoras'
      DataSource = dsPermisoAusencia
      TabOrder = 2
      ValueChecked = 'Si'
      ValueUnchecked = 'No'
      OnClick = PorHorasClick
    end
    object Causa: TDBComboBox
      Left = 113
      Top = 231
      Width = 131
      Height = 21
    ...
    object hInicio: TcxDBTimeEdit
      Left = 223
      Top = 83
      TabOrder = 7
      Width = 83
    end
    object hTermino: TcxDBTimeEdit
      Left = 223
      Top = 110
      TabOrder = 8
      Width = 83
    end
    object Inicio: TcxDBDateEdit
      Left = 111
      Top = 83
      DataBinding.DataField = 'Inicio'
      DataBinding.DataSource = dsPermisoAusencia
      TabOrder = 9
      Width = 90
    end
    object Termino: TcxDBDateEdit
      Left = 111
      Top = 110
  ...
  object FechaSolicitud: TcxDBDateEdit
    Left = 111
    Top = 96
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.CreateDate = 42979.433365601850000000
    ReportOptions.LastChange = 42979.585754074070000000
    ...
    Datasets = <
      item
        DataSet = frxDBPermiso
        DataSetName = 'frxDBPermiso'
      end>
    Variables = <>
    Style = <>
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo15: TfrxMemoView
          ...
          Height = 30.236240000000000000
          DataField = 'NombreCompletoSupervisor'
          DataSet = frxDBPermiso
          DataSetName = 'frxDBPermiso'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBPermiso."NombreCompletoSupervisor"]')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo52: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'SI ES TIEMPO POR TIEMPO ESPECIFIQUE LA FECHA DE RECUPERACI'#211'N DE ' +
              'LAS HORAS')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo61: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'CONDICIONES DE ACEPTACI'#211'N DE LA UNIDAD DE RECURSOS HUMANOS')
          ParentFont = False
        end
        object Memo62: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'Este formato se aceptar'#225' en la unidad de Recursos Humanos, para ' +
              'los casos donde aplique la documentaci'#243'n de respaldo se adjunta ' +
              'y se entregue a m'#225's tardar al d'#237'a siguiente de haberse otorgado ' +
              'el mismo.')
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 740.787880000000000000
        Condition = 'frxDBPermiso."IdPersonal"'
  ...
  object cdPermisoAusencia: TZQuery
    Connection = connection.zConnection
    BeforePost = cdPermisoAusenciaBeforePost
    AfterPost = cdPermisoAusenciaAfterPost
    Params = <>
    Left = 688
    Top = 32
  end
  ...
  object dsPermisoAusencia: TDataSource
    DataSet = cdPermisoAusencia
    Left = 576
    Top = 32
  end
  ...
  object frxDBPermiso: TfrxDBDataset
    UserName = 'frxDBPermiso'
    CloseDataSource = False
    FieldAliases.Strings = (
      'IdPermisoAusencia=IdPermisoAusencia'
      ...
      'LeyendaTipoPermiso=LeyendaTipoPermiso'
      'Tiempo=Tiempo'
      'Causa=Causa'
      ...
      'IdLocalidadHist=IdLocalidadHist'
