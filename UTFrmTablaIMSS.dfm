object FrmTablaIMSS: TFrmTablaIMSS
  ...
  object pnl_DatosLinea: TPanel
    ...
    object edtPctPatron: TcxDBCalcEdit
      Left = 120
      Top = 90
    ...
    object edtPctEmpleado: TcxDBCalcEdit
      Left = 274
      Top = 90
    ...
    object cmbAplicarSobre: TDBComboBox
      Left = 120
      Top = 144
      Width = 89
      Height = 21
    ...
    object cmbExentoSobre: TDBComboBox
      Left = 120
      Top = 171
      Width = 89
      Height = 21
    ...
    object edtCuantoExento: TcxDBCalcEdit
      Left = 218
      Top = 171
      DataBinding.DataField = 'CuantoExcento'
      DataBinding.DataSource = dsDatos
      TabOrder = 8
      Width = 53
    end
    object dtpAplicacion: TcxDBDateEdit
      Left = 120
      Top = 13
